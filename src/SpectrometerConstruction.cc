...
:fCheckOverlaps(true)
{
  ...
  slitshth = 1*CLHEP::mm; //arbitrary thickness
  ...
  //User Limits
  G4double minStep = 0.0001 * CLHEP::mm; //Integrator minstep
  ...
  RotateTube2->rotateX(90*CLHEP::deg);
	...
	G4double Q1HL = 13.977/2*CLHEP::cm;		//mag. eff. field half length
	G4double Q1apt = 3.1*CLHEP::cm;	//radius of apeture of vacuum chamber
	G4double Pipe2HL = 3.5/4*CLHEP::cm;	// this is divided by 4 because the the physical length (7 cm) is actually constructed from two pipes (2 and 3)
	G4double Q2HL = 29.881/2*CLHEP::cm;	//mag. eff. field half length
	G4double Q2apt = 6.75*CLHEP::cm;
	Pipe4HL = 37.23/4*CLHEP::cm;  // see above comment about division by 4
	G4double Pipe5HL = Pipe4HL;
	G4double wallThick = 1*CLHEP::cm;	//arbitrary thickness of vacuum chamber walls
	G4double rbigpipe = 13.75*CLHEP::cm; //arbitrary size
    ...
    //
    // Pipe1Cap1
    G4VSolid* Pipe1Cap1Solid = new G4Tubs("Pipe1Cap1Tub",rbigpipe,rbigpipe+wallThick,2*CLHEP::cm,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Pipe1Cap1Logical = new G4LogicalVolume(Pipe1Cap1Solid,Wall,"Pipe1Cap1Logical", 0,0,0);
	G4double Pipe1Cap1z = -1*CLHEP::cm;
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe1Cap1z),Pipe1Cap1Logical,"Pipe1Cap1Physical",SpecWorldLogical,0,0,fCheckOverlaps);
    //
    // Pipe1Cap2
    G4VSolid* Pipe1Cap2Solid = new G4Tubs("Pipe1Cap2Tub",0*CLHEP::cm,rbigpipe+wallThick,1*CLHEP::cm,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Pipe1Cap2Logical = new G4LogicalVolume(Pipe1Cap2Solid,Wall,"Pipe1Cap2Logical", 0,0,0);
	G4double Pipe1Cap2z = Pipe1Cap1z-1.5*CLHEP::cm;
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe1Cap2z),Pipe1Cap2Logical,"Pipe1Cap2Physical",SpecWorldLogical,0,0,fCheckOverlaps);
    //
	// Pipe1Cap3
	G4VSolid* Pipe1Cap3Solid = new G4Tubs("Pipe1Cap3Tub",Q1apt+wallThick,rbigpipe+wallThick,1*CLHEP::cm,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Pipe1Cap3Logical = new G4LogicalVolume(Pipe1Cap3Solid,Wall,"Pipe1Cap3Logical", 0,0,0);
	G4double Pipe1Cap3z = zQ1begins+0.5*CLHEP::cm;
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe1Cap3z),Pipe1Cap3Logical,"Pipe1Cap3Physical",SpecWorldLogical,0,0,fCheckOverlaps);
	//
    //<><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>//
    //
    //
	...
	// Pipe1
	G4VSolid* Pipe1Solid = new G4Tubs("Pipe1Tub",0*CLHEP::cm,rbigpipe,Pipe1HL,0*CLHEP::deg,360*CLHEP::deg);
	// Pipe1Wall
	G4VSolid* Pipe1WallSolid = new G4Tubs("Pipe1WallTub",rbigpipe,rbigpipe+wallThick,Pipe1HL,0*CLHEP::deg,360*CLHEP::deg);
	...
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe1z),Pipe1WallLogical,"Pipe1WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);

	// Q1
	G4VSolid* Q1Solid = new G4Tubs("Q1Tub",0*CLHEP::cm,Q1apt,Q1HL,0*CLHEP::deg,360*CLHEP::deg);
	// Q1Wall
	G4VSolid* Q1WallSolid = new G4Tubs("Q1WallTub",Q1apt,Q1apt+wallThick,Q1HL,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Q1WallLogical = new G4LogicalVolume(Q1WallSolid,Wall,"Q1WallLogical",0,0,0);
	G4double Q1z = Pipe1z+Pipe1HL+Q1HL;
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Q1z),Q1WallLogical,"Q1WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	Q1WallLogical->SetVisAttributes(PoleVisAtt);

	// Pipe2
	G4VSolid* Pipe2Solid = new G4Tubs("Pipe2Tub",0*CLHEP::cm,Q1apt,Pipe2HL,0*CLHEP::deg,360*CLHEP::deg);
	// Pipe2Wall
	G4VSolid* Pipe2WallSolid = new G4Tubs("Pipe2WallTub",Q1apt,Q1apt+wallThick,Pipe2HL,0*CLHEP::deg,360*CLHEP::deg);
	...
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe2z),Pipe2WallLogical,"Pipe2WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);

	//Create Union for field element
	G4ThreeVector Q1off(0*CLHEP::cm,0,Pipe1HL+Q1HL);
	...
	G4ThreeVector Pipe2off(0*CLHEP::cm,0*CLHEP::cm,Pipe1HL+2*Q1HL+Pipe2HL);
	...
	Field1 = new BGField1(0,zQ1fieldbegins,Q1before,Q1after,Q1Logical,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Q1Solidz)); //see BGField1.cc for 	description of input parameters

	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Q1Solidz),Q1Logical,"Q1Physical",SpecWorldLogical,0,0,fCheckOverlaps);
	Q1Logical->SetVisAttributes(BendingVisAtt);
 	...
 	//
  	//    Aperture (aluminum)
  	//
  	G4VSolid* apertureOuterSolid = new G4Box("apertureOuterSolid",5*CLHEP::cm,5*CLHEP::cm,1.*CLHEP::um); // arbitrarily thin.
  	G4VSolid* apertureHole = new G4Box("apertureHole",4.185*CLHEP::cm,4.185*CLHEP::cm,1.*CLHEP::cm); // arbitrarily thick.
  	...
  	G4double zAperture = -43.95*CLHEP::mm;
	...
	// Pipe3
	G4VSolid* Pipe3Solid = new G4Tubs("Pipe3Tub",0*CLHEP::cm,Q1apt,Pipe2HL,0*CLHEP::deg,360*CLHEP::deg);
	// Pipe3Wall
	G4VSolid* Pipe3WallSolid = new G4Tubs("Pipe3WallTub",Q1apt,Q1apt+wallThick,Pipe2HL,0*CLHEP::deg,360*CLHEP::deg);
	...
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe3z),Pipe3WallLogical,"Pipe3WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
  ...
  /*
	...
	*/
	...
	G4VSolid* Pipe3WallExtSolid = new G4Tubs("Pipe3WallExtTub",Q1apt,Q1apt+wallThick,Q2SubHL,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Pipe3WallExtLogical = new G4LogicalVolume(Pipe3WallExtSolid,Wall,"Pipe3WallExtLogical", 0,0,0);
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe3z+Pipe2HL+Q2SubHL),Pipe3WallExtLogical,"Pipe3WallExtPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	...
	// Q2
	G4VSolid* Q2Sub = new G4Tubs("Q2SubTub",Q1apt,Q1apt+wallThick,Q2SubHL,0*CLHEP::deg,360*CLHEP::deg);
	G4VSolid* Q2Cyl = new G4Tubs("Q2TubCyl",0*CLHEP::cm,Q2apt,Q2HL,0*CLHEP::deg,360*CLHEP::deg);
	G4ThreeVector Q2Suboff(0*CLHEP::cm,0*CLHEP::cm,-Q2HL+Q2SubHL);
	G4SubtractionSolid* Q2Solid = new G4SubtractionSolid("Q2TubCyl-Q1SubTub",Q2Cyl,Q2Sub,Rotate0,Q2Suboff);

	// Q2Wall
	G4VSolid* Q2WallSolid = new G4Tubs("Q2WallTub",Q2apt,Q2apt+wallThick,Q2HL,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Q2WallLogical = new G4LogicalVolume(Q2WallSolid,Wall,"Q2WallLogical",0,0,0);
	G4double Q2z = Pipe3z+Pipe2HL+Q2HL;
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Q2z),Q2WallLogical,"Q2WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	...
	// Pipe4
	G4VSolid* Pipe4Solid = new G4Tubs("Pipe4Tub",0*CLHEP::cm,Q2apt,Pipe4HL,0*CLHEP::deg,360*CLHEP::deg);
	// Pipe4Wall
	G4VSolid* Pipe4WallSolid = new G4Tubs("Pipe4WallTub",Q2apt,Q2apt+wallThick,Pipe4HL,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Pipe4WallLogical = new G4LogicalVolume(Pipe4WallSolid,Wall,"Pipe4WallLogical", 0,0,0);
	 Pipe4z = Q2z+Q2HL+Pipe4HL;
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe4z),Pipe4WallLogical,"Pipe4WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	...
	G4ThreeVector Q2off(0*CLHEP::cm,0,Pipe2HL+Q2HL);
	G4UnionSolid* Q2a = new G4UnionSolid("Q2a", Pipe3Solid, Q2Solid, Rotate0, Q2off);
	G4ThreeVector Pipe4off(0*CLHEP::cm,0*CLHEP::cm,Pipe2HL+2*Q2HL+Pipe4HL);
	...
	Field2 = new BGField2(0,zQ2fieldbegins,Q2before,Q2after,Q2Logical,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Q2Solidz)); //see BGField2.cc for description of input parameters

	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Q2Solidz),Q2Logical,"Q2Physical",SpecWorldLogical,0,0,fCheckOverlaps);
	Q2Logical->SetVisAttributes(BendingVisAtt);
 	...
 	// Pipe5
	G4VSolid* Pipe5Solid = new G4Tubs("Pipe5Tub",0*CLHEP::cm,Q2apt,Pipe5HL,0*CLHEP::deg,360*CLHEP::deg);
	// Pipe5Wall
	G4VSolid* Pipe5WallSolid = new G4Tubs("Pipe5WallTub",Q2apt,Q2apt+wallThick,Pipe5HL,0*CLHEP::deg,360*CLHEP::deg);
	...
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe5z),Pipe5WallLogical,"Pipe5WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	...
	G4double x0=500*CLHEP::cm; //radius of the curvature of ED1
	G4double EDhw = 6.25*CLHEP::cm; //ED width
	G4double EDhh = 20*CLHEP::cm; //ED height
	G4double ED1angle = 20*CLHEP::deg; //ED bending angle
	...
	// ED1
	G4VSolid* ED1Solid = new G4Tubs("ED1Tub",x0-EDhw,x0+EDhw,EDhh,360*CLHEP::deg,ED1angle);

	// ED1 Walls:
	// Wall 1: x<0 (down) [EAST]
	G4VSolid* ED1Wall1Solid = new G4Tubs("ED1Wall1Tub", x0-EDhw-wallThick, x0-EDhw, EDhh+wallThick, 360*CLHEP::deg, ED1angle);
	G4LogicalVolume* ED1Wall1Logical = new G4LogicalVolume(ED1Wall1Solid,Wall,"ED1Wall1Logical", 0,0,0);
	new G4PVPlacement(RotateTube,G4ThreeVector(-x0,0*CLHEP::cm,ED1z),ED1Wall1Logical,"ED1Wall1Physical",SpecWorldLogical,0,0,fCheckOverlaps);
	// Wall 2: x>0 (up)   [WEST]
	G4VSolid* ED1Wall2Solid = new G4Tubs("ED1Wall2Tub", x0+EDhw, x0+EDhw+wallThick, EDhh+wallThick, 360*CLHEP::deg, ED1angle);
	G4LogicalVolume* ED1Wall2Logical = new G4LogicalVolume(ED1Wall2Solid,Wall,"ED1Wall2Logical", 0,0,0);
	new G4PVPlacement(RotateTube,G4ThreeVector(-x0,0*CLHEP::cm,ED1z),ED1Wall2Logical,"ED1Wall2Physical",SpecWorldLogical,0,0,fCheckOverlaps);
	// Wall 3: y>0 (into screen)   [CENTRE OF EARTH]
	G4VSolid* ED1Wall3Solid = new G4Tubs("ED1Wall3Tub", x0-EDhw, x0+EDhw, wallThick/2.0, 360*CLHEP::deg, ED1angle);
	...
	G4VSolid* ED1Wall4Solid = new G4Tubs("ED1Wall4Tub", x0-EDhw, x0+EDhw, wallThick/2.0, 360*CLHEP::deg, ED1angle);
	...
	Rotate1->rotateY(20*CLHEP::deg);

	// Rectangular aperture slit after ED1
	G4double xapth = 12.5/2*CLHEP::cm;
	G4double yapth = 40/2*CLHEP::cm;
	G4double slitshout = 20*CLHEP::cm; //width of aluminum plate extending out
	...
	G4double Pipe6HL = 59.64/2*CLHEP::cm;
		 Pipe7HL = 20.26/2*CLHEP::cm;
	G4double Pipe1MDHL = 42.6/2*CLHEP::cm;
	G4double Pipe2MDHL = 42.6/2*CLHEP::cm;
	G4double Pipe8HL = 18.77/2*CLHEP::cm;
	G4double Pipe9HL = 61.13/2*CLHEP::cm;
	...
	G4double MDr = 100*CLHEP::cm; //radius of the curvature of MD
	G4double MDangle = 40*CLHEP::deg;
	G4double MDhh = 6*CLHEP::cm;
	G4double MDhw = 20*CLHEP::cm;
	...
	Pipe6off[1] = 0*CLHEP::cm;
	Pipe6off[2] = Pipe5HL+EDendz+Pipe6HL*cos(Pipe6angle);

	// *********************************************** //
	// Fix drift space lengths and magnetic effective field lengths
	//
	G4double Pipe10HL=26.84/4*CLHEP::cm;
	G4double Pipe11HL=Pipe10HL;
	G4double Q3apt1HL=9.65/2*CLHEP::cm;
	G4double Q3HL=29.882/2*CLHEP::cm;	//mag. eff. field hal length
	G4double Q3apt = 6.75*CLHEP::cm;
	G4double Q3apt2HL=3./2*CLHEP::cm;
	G4double Q4HL = 40.179/2*CLHEP::cm; //mag. eff. field half length
	G4double Q4apt = 18.5/2*CLHEP::cm;
	G4double Pipe12HL=20.92/2*CLHEP::cm;
	G4double Pipe13HL = 3.2/2*CLHEP::cm;
	G4double Pipe14HL = 3.32/2*CLHEP::cm;   // original value: 11.73cm, then 6.64, now 3.92
	...
	// Pipe6
	G4VSolid* Pipe6Solid = new G4Tubs("Pipe6Tub", 0*CLHEP::cm, rbigpipe, Pipe6HL, 0*CLHEP::deg, 360*CLHEP::deg);
	// Pipe6Wall
	G4VSolid* Pipe6WallSolid = new G4Tubs("Pipe6WallTub", rbigpipe, rbigpipe+wallThick, Pipe6HL, 0*CLHEP::deg, 360*CLHEP::deg);
	...
	RotateED1->rotateY(20*CLHEP::deg);
	...
	Field3 = new BGField3(0,zED1fieldbegins,ED1before,ED1after,ED1Logical,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe5z)); //see BGField3.cc for description of input parameters

	if (vacuumRegion) vacuumRegion->AddRootLogicalVolume(ED1Logical);
	ED1Logical->SetRegion(vacuumRegion);
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe5z),ED1Logical,"ED1Physical",SpecWorldLogical,0,0,fCheckOverlaps);
	...
	// Pipe7
	G4VSolid* Pipe7Solid = new G4Tubs("Pipe7Tub", 0*CLHEP::cm, rbigpipe, Pipe7HL-2*slitshth, 0*CLHEP::deg, 360*CLHEP::deg);
	...
	// Pipe7Wall
	G4VSolid* Pipe7WallSolid = new G4Tubs("Pipe7WallTub", rbigpipe, rbigpipe+wallThick, Pipe7HL-2*slitshth, 0*CLHEP::deg, 360*CLHEP::deg);
	...
	xapth = 20.5/2*CLHEP::cm;
	yapth = 9.2/2*CLHEP::cm;
	...
	// Pipe1MD
	G4VSolid* Pipe1MDSolid = new G4Tubs("Pipe1MDTub", 0*CLHEP::cm, rbigpipe, Pipe1MDHL, 0*CLHEP::deg, 360*CLHEP::deg);
	// Pipe1MD
	G4VSolid* Pipe1MDWallSolid = new G4Tubs("Pipe1MDWallTub", rbigpipe, rbigpipe+wallThick, Pipe1MDHL, 0*CLHEP::deg, 360*CLHEP::deg);
	...
	// If there is a problem with the position of the EDIP the problem is most likely in the start angle
	// MD
	G4VSolid* MDSolid = new G4Tubs("MDTub",MDr-MDhw,MDr+MDhw,MDhh,140*CLHEP::deg,MDangle);

	// MDWalls:
	G4VSolid* MDWall1Solid = new G4Tubs("MDWall1Tub",MDr-MDhw-wallThick,MDr-MDhw,MDhh+wallThick,160*CLHEP::deg,MDangle);
	G4LogicalVolume* MDWall1Logical = new G4LogicalVolume(MDWall1Solid,Wall,"MDWall1Logical", 0,0,0);
	new G4PVPlacement(RotateTube,G4ThreeVector(xMD,0*CLHEP::cm,zMD),MDWall1Logical,"MDWall1Physical",SpecWorldLogical,0,0,fCheckOverlaps);
   	G4VSolid* MDWall2Solid = new G4Tubs("MDWall2Tub",MDr+MDhw,MDr+MDhw+wallThick,MDhh+wallThick,160*CLHEP::deg,MDangle);
	G4LogicalVolume* MDWall2Logical = new G4LogicalVolume(MDWall2Solid,Wall,"MDWall2Logical", 0,0,0);
	new G4PVPlacement(RotateTube,G4ThreeVector(xMD,0*CLHEP::cm,zMD),MDWall2Logical,"MDWall2Physical",SpecWorldLogical,0,0,fCheckOverlaps);
	G4VSolid* MDWall3Solid = new G4Tubs("MDWall3Tub",MDr-MDhw,MDr+MDhw,wallThick/2,160*CLHEP::deg,MDangle);
	...
	G4VSolid* MDWall4Solid = new G4Tubs("MDWall4Tub",MDr-MDhw,MDr+MDhw,wallThick/2,160*CLHEP::deg,MDangle);
	...
	Rotate2->rotateY(-20*CLHEP::deg);

	// Pipe2MD
	G4VSolid* Pipe2MDSolid = new G4Tubs("Pipe2MDTub", 0*CLHEP::cm, rbigpipe, Pipe2MDHL, 0*CLHEP::deg, 360*CLHEP::deg);
	// Pipe2MD
	G4VSolid* Pipe2MDWallSolid = new G4Tubs("Pipe2MDWallTub", rbigpipe, rbigpipe+wallThick, Pipe2MDHL, 0*CLHEP::deg, 360*CLHEP::deg);
	...
	// Pipe8
	G4VSolid* Pipe8Solid = new G4Tubs("Pipe8Tub",0*CLHEP::cm, rbigpipe, Pipe8HL-2*slitshth, 0*CLHEP::deg, 360*CLHEP::deg);
	...
	// Pipe8Wall
	G4VSolid* Pipe8WallSolid = new G4Tubs("Pipe8WallTub", rbigpipe, rbigpipe+wallThick, Pipe8HL-2*slitshth, 0*CLHEP::deg, 360*CLHEP::deg);
	...
	// Pipe9
	G4VSolid* Pipe9Solid = new G4Tubs("Pipe9Tub",0*CLHEP::cm,rbigpipe,Pipe9HL,0*CLHEP::deg,360*CLHEP::deg);
	// Pipe9Wall
	G4VSolid* Pipe9WallSolid = new G4Tubs("Pipe9WallTub",rbigpipe,rbigpipe+wallThick,Pipe9HL,0*CLHEP::deg,360*CLHEP::deg);
	...
	// ED2
	G4VSolid* ED2Solid = new G4Tubs("ED2Tub",x0-EDhw,x0+EDhw,EDhh,340*CLHEP::deg, ED1angle);

	// ED2 Walls
	// Wall 1: x<0 (down)
	G4VSolid* ED2Wall1Solid = new G4Tubs("ED2Wall1Tub",x0-EDhw-wallThick, x0-EDhw, EDhh+wallThick, 340*CLHEP::deg, ED1angle);
	...
	new G4PVPlacement(RotateTube,G4ThreeVector(-x0,0*CLHEP::cm,ED2z),ED2Wall1Logical,"ED2Wall1Physical",SpecWorldLogical,0,0,fCheckOverlaps);
	// Wall 2: x>0 (up)
	G4VSolid* ED2Wall2Solid = new G4Tubs("ED2Wall2Tub", x0+EDhw, x0+EDhw+wallThick, EDhh+wallThick, 340*CLHEP::deg, ED1angle);
	G4LogicalVolume* ED2Wall2Logical = new G4LogicalVolume(ED2Wall2Solid,Wall,"ED2Wall2Logical", 0,0,0);
	new G4PVPlacement(RotateTube,G4ThreeVector(-x0,0*CLHEP::cm,ED2z),ED2Wall2Logical,"ED2Wall2Physical",SpecWorldLogical,0,0,fCheckOverlaps);
	// Wall 3: y>0 (into screen)
	G4VSolid* ED2Wall3Solid = new G4Tubs("ED2Wall3Tub", x0-EDhw, x0+EDhw, wallThick/2.0, 340*CLHEP::deg, ED1angle);
	...
	G4VSolid* ED2Wall4Solid = new G4Tubs("ED2Wall4Tub", x0-EDhw, x0+EDhw, wallThick/2.0, 340*CLHEP::deg, ED1angle);
	...
	Rotate3->rotateY(0*CLHEP::deg);

	// Pipe10
	G4VSolid* Pipe10Solid = new G4Tubs("Pipe10Tub",0*CLHEP::cm,rbigpipe,Pipe10HL,0*CLHEP::deg,360*CLHEP::deg);
	// Pipe10Wall
	G4VSolid* Pipe10WallSolid = new G4Tubs("Pipe10WallTub",rbigpipe,rbigpipe+wallThick,Pipe10HL,0*CLHEP::deg,360*CLHEP::deg);
	...
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe10z),Pipe10WallLogical,"Pipe10WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	//Pipe10WallLogical->SetVisAttributes(WallVisAtt);

	//Create Union for field element
	// Create rotation matrix for following pipe
	G4RotationMatrix* RotateED2 = new G4RotationMatrix();
	RotateED2->rotateY(-20*CLHEP::deg);
	...
	new G4PVPlacement(Rotate0,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe10z),ED2Logical,"ED2Physical",SpecWorldLogical,0,0,fCheckOverlaps);
	ED2Logical->SetVisAttributes(BendingVisAtt);

	Field5 = new BGField5(xED2fieldbegins,zED2fieldbegins,ED2before,ED2after,ED2Logical,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe10z)); //see BGField5.cc for description of input parameters
	...
	// Pipe11
	G4VSolid* Pipe11Solid = new G4Tubs("Pipe11Tub",0*CLHEP::cm,rbigpipe,Pipe11HL,0*CLHEP::deg,360*CLHEP::deg);
	// Pipe11Wall
	G4VSolid* Pipe11WallSolid = new G4Tubs("Pipe11WallTub",rbigpipe,rbigpipe+wallThick,Pipe11HL,0*CLHEP::deg,360*CLHEP::deg);
	...
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe11z),Pipe11WallLogical,"Pipe11WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	//Pipe11WallLogical->SetVisAttributes(WallVisAtt);

	//********************************
	// Pipe11Cap (Detector end caps)
	G4VSolid* Pipe11CapSolid = new G4Tubs("Pipe11CapTub",Q3apt+wallThick,rbigpipe+wallThick,0.5*CLHEP::cm,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Pipe11CapLogical = new G4LogicalVolume(Pipe11CapSolid,Wall,"Pipe11CapLogical", 0,0,0);
	G4double Pipe11Capz = Pipe10z+Pipe10HL+Pipe11HL+Pipe11HL+0.5*CLHEP::cm;
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe11Capz),Pipe11CapLogical,"Pipe11CapPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	//********************************

	// Q3 vacuum pipe extending out before magnet
	G4VSolid* Q3apt1Solid = new G4Tubs("Q3apt1Tub",0*CLHEP::cm,Q3apt,Q3apt1HL,0*CLHEP::deg,360*CLHEP::deg);
	// Q3apt1Wall
	G4VSolid* Q3apt1WallSolid = new G4Tubs("Q3apt1WallTub",Q3apt,Q3apt+wallThick,Q3apt1HL,0*CLHEP::deg,360*CLHEP::deg);
	...
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Q3apt1z),Q3apt1WallLogical,"Q3apt1WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);


	// Q3
	G4VSolid* Q3Solid = new G4Tubs("Q3Tub",0*CLHEP::cm,Q3apt,Q3HL,0*CLHEP::deg,360*CLHEP::deg);
	// Q3Wall
	G4VSolid* Q3WallSolid = new G4Tubs("Q3WallTub",Q3apt,Q3apt+wallThick,Q3HL,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Q3WallLogical = new G4LogicalVolume(Q3WallSolid,Wall,"Q3WallLogical",0,0,0);
	G4double Q3z = Q3apt1z+Q3apt1HL+Q3HL;
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Q3z),Q3WallLogical,"Q3WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	Q3WallLogical->SetVisAttributes(PoleVisAtt);

	// Q3 vacuum pipe extending out before magnet
	G4VSolid* Q3apt2Solid = new G4Tubs("Q3apt2Tub",0*CLHEP::cm,Q3apt,Q3apt2HL,0*CLHEP::deg,360*CLHEP::deg);
	// Q3apt2Wall
	G4VSolid* Q3apt2WallSolid = new G4Tubs("Q3apt2WallTub",Q3apt,Q4apt+wallThick,Q3apt2HL,0*CLHEP::deg,360*CLHEP::deg);
	...
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Q3apt2z),Q3apt2WallLogical,"Q3apt2WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	...
	G4ThreeVector Q3off(0*CLHEP::cm,0,Pipe11HL+Q3apt1HL);
	...
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe11z),Q3Logical,"Q3Physical",SpecWorldLogical,0,0,fCheckOverlaps);
	Q3Logical->SetVisAttributes(BendingVisAtt);

	 Field6 = new BGField6(0,zQ3fieldbegins,Q3before,Q3after,Q3Logical,G4ThreeVector(0*CLHEP::m,0*CLHEP::cm,Pipe11z)); //see BGField6.cc for description of input parameters


	// Q4
	G4VSolid* Q4Solid = new G4Tubs("Q4Tub",0*CLHEP::cm,Q4apt,Q4HL,0*CLHEP::deg,360*CLHEP::deg);
	// Q4Wall
	G4VSolid* Q4WallSolid = new G4Tubs("Q4WallTub",Q4apt,Q4apt+wallThick,Q4HL,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Q4WallLogical = new G4LogicalVolume(Q4WallSolid,Wall,"Q4WallLogical",0,0,0);
	G4double Q4z = Q3apt2z+Q3apt2HL+Q4HL;
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Q4z),Q4WallLogical,"Q4WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	Q4WallLogical->SetVisAttributes(PoleVisAtt);

	// Pipe12
	G4VSolid* Pipe12Solid = new G4Tubs("Pipe12Tub",0*CLHEP::cm,rbigpipe,Pipe12HL,0*CLHEP::deg,360*CLHEP::deg);
	// Pipe12Wall
	G4VSolid* Pipe12WallSolid = new G4Tubs("Pipe12WallTub",rbigpipe,rbigpipe+wallThick,Pipe12HL,0*CLHEP::deg,360*CLHEP::deg);
	...
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe12z),Pipe12WallLogical,"Pipe12WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	//Pipe12WallLogical->SetVisAttributes(WallVisAtt);

	//********************************
	// Pipe12Cap (Detector end cap)
	G4VSolid* Pipe12CapSolid = new G4Tubs("Pipe12CapTub",Q4apt+wallThick,rbigpipe+wallThick,0.5*CLHEP::cm,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Pipe12CapLogical = new G4LogicalVolume(Pipe12CapSolid,Wall,"Pipe12CapLogical", 0,0,0);
	G4double Pipe12Capz = Q4z+Q4HL-0.5*CLHEP::cm;
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe12Capz),Pipe12CapLogical,"Pipe12CapPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	//********************************
	...
	G4ThreeVector Q4off(0*CLHEP::cm,0,Q4HL+Pipe12HL);
	...
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Q4z),Q4Logical,"Q4Physical",SpecWorldLogical,0,0,fCheckOverlaps);
	Q4Logical->SetVisAttributes(BendingVisAtt);

	Field7 = new BGField7(0,zQ4fieldbegins,Q4before,Q4after,Q4Logical,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Q4z)); //see BGField7.cc for description of input parameters
	...
	G4double x = 0*CLHEP::cm;
	G4double y = 0*CLHEP::cm;
	...
	// Pipe13
	G4VSolid* Pipe13Solid = new G4Tubs("Pipe13Tub",0*CLHEP::cm,rbigpipe,Pipe13HL-slitshth,0*CLHEP::deg,360*CLHEP::deg);
	...
	new G4PVPlacement(Rotate3, G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe13z), Pipe13Logical, "Pipe13Physical", SpecWorldLogical,0,0,fCheckOverlaps);
	// Pipe13Wall
	G4VSolid* Pipe13WallSolid = new G4Tubs("Pipe13WallTub",rbigpipe,rbigpipe+wallThick,Pipe13HL-slitshth,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Pipe13WallLogical = new G4LogicalVolume(Pipe13WallSolid,Wall,"Pipe13WallLogical", 0,0,0);
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe13z),Pipe13WallLogical,"Pipe13WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
	...
	// Pipe14
	G4VSolid* Pipe14Solid = new G4Tubs("Pipe14Tub",0*CLHEP::cm,rbigpipe,Pipe14HL-slitshth,0*CLHEP::deg,360*CLHEP::deg);
	...
	new G4PVPlacement(Rotate3, G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe14z), Pipe14Logical, "Pipe14Physical", SpecWorldLogical,0,0,fCheckOverlaps);
	// Pipe14Wall
	G4VSolid* Pipe14WallSolid = new G4Tubs("Pipe14WallTub",rbigpipe,rbigpipe+wallThick,Pipe14HL-slitshth,0*CLHEP::deg,360*CLHEP::deg);
	G4LogicalVolume* Pipe14WallLogical = new G4LogicalVolume(Pipe14WallSolid,Wall,"Pipe14WallLogical", 0,0,0);
	new G4PVPlacement(Rotate3,G4ThreeVector(0*CLHEP::cm,0*CLHEP::cm,Pipe14z),Pipe14WallLogical,"Pipe14WallPhysical",SpecWorldLogical,0,0,fCheckOverlaps);
...
//------------------------------------------------------------------------------------------//
	...
	zAnode = posSlits4[2] + slitshth + (66.4)*CLHEP::mm; //Pipe14z+(Pipe14HL-slitshth); // Distance to focal plane (Anode)4
	//zFocalPlane = Pipe14z+(Pipe14HL-sliefltshth);
	zFocalPlane = zQ4ends + 307.6*CLHEP::mm;
      ...
      if (text=="#") { // skip comments
    	...
    	n = n+1;
  	    if (text=="OUT") { //slits out
    	    val=200*CLHEP::cm; //very large aperture width
    	    if(n==3||n==4)val=100*CLHEP::cm;
	    }
	    else if (text!="OUT" ) { //slits in with specified width
	      val=atof(text.c_str())*CLHEP::mm;
	    }
